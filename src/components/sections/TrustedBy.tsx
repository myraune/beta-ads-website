...
export const TrustedBy: React.FC = () => {
  ...
  return <section id="trusted-by" className="py-8 overflow-hidden relative">
          ...
          WebkitMaskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)'
            ...
            <div className="flex animate-scroll">
              ...
              <div className="flex items-center space-x-24 whitespace-nowrap dark:hidden">
                ...
                <div className="h-10 w-28 flex items-center justify-center">
                  <img alt="Surfshark" loading="lazy" decoding="async" className="max-h-10 max-w-28 opacity-50 object-contain transition-all duration-300 hover:scale-110 hover:opacity-80" src="/lovable-uploads/08646782-d620-4f3a-bcd4-128419cc79d3.png" />
                </div>
                <div className="h-10 w-28 flex items-center justify-center">

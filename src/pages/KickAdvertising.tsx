      ...
      seo={{
        ...
        jsonLd: [
          ...
          { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
            ...
            { "@type": "Question", name: "Why advertise on Kick instead of Twitch?", acceptedAnswer: { "@type": "Answer", text: "Kick grew 125% while Twitch declined 10% in 2025. Kick has lower ad saturation, longer viewing sessions (120+ minutes vs 90 minutes on Twitch), and first-mover advantage for brands entering the platform before competition arrives." } },
            { "@type": "Question", name: "How many Kick streamers are there in the Nordics?", acceptedAnswer: { "@type": "Answer", text: "Beta Ads has access to 2,800+ Nordic Kick streamers across Norway, Sweden, Finland, and Denmark. Many are creators who have migrated from Twitch and bring established audiences with them." } },
            { "@type": "Question", name: "What types of content are on Kick?", acceptedAnswer: { "@type": "Answer", text: "Kick hosts gaming, IRL streams, sports betting, and creator-led content. The platform is known for fewer content restrictions compared to Twitch, attracting a diverse range of creators and audiences." } },
            { "@type": "Question", name: "How do I start a Kick advertising campaign?", acceptedAnswer: { "@type": "Answer", text: "Contact Beta Ads for a campaign proposal. We match your brand with relevant Kick creators, handle creative production, and manage deployment. Campaigns can go live in as little as 5 business days." } },
          ] },
        ],
      }}
      cta={{
      ...
      <section className="py-20 md:py-28 border-t border-border">
        <div ref={compRef} className={`max-w-7xl mx-auto px-6 lg:px-12 transition-all duration-700 ${compVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="grid md:grid-cols-4 gap-5">
            {platforms.map((p) => {
              const isCurrentPage = p.name === "Kick";

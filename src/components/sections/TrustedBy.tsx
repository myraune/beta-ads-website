          ...
          <div className="flex overflow-hidden">
            <div className="flex animate-scroll">
              ...
              <div className="hidden dark:flex items-center space-x-16 whitespace-nowrap">
                ...
                <div className="h-16 w-40 flex items-center justify-center">
                  <img src="/lovable-uploads/2c535017-d05f-4886-9c58-9ca401e9b44f.png" alt="Komplett" className="h-12 w-auto opacity-80 object-contain" />
                </div>
                <div className="h-16 w-40 flex items-center justify-center">
                  <img src="/lovable-uploads/958b1a7f-a00c-46bc-acdb-bbefda64b9da.png" alt="Shure" className="h-12 w-auto opacity-80 object-contain" />
                </div>
                <div className="h-16 w-40 flex items-center justify-center">
                ...
                <div className="h-16 w-40 flex items-center justify-center">
                  <img src="/lovable-uploads/9fee36e6-a901-40bb-961b-b20b878b80de.png" alt="SteelSeries" className="h-12 w-auto opacity-80 object-contain" />
                </div>
              </div>
              <div className="hidden dark:flex items-center space-x-16 whitespace-nowrap">
                <div className="h-16 w-40 flex items-center justify-center">

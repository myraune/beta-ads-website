    ...
    <div className="max-w-7xl mx-auto px-8 lg:px-12">
      <div className="grid md:grid-cols-4 gap-16">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4 text-muted-foreground font-extralight text-lg">
            <p
              className={`hover:text-foreground transition-colors cursor-pointer tracking-wide ${language === "en" ? "text-foreground" : ""}`}
              onClick={() => setLanguage("en")}
            >
              🇺🇸 English
            </p>
            <p
              className={`hover:text-foreground transition-colors cursor-pointer tracking-wide ${language === "no" ? "text-foreground" : ""}`}

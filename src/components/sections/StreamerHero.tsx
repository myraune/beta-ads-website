...
const offers = [
  ...
  },
  {
    ...
    streamBg: "/lovable-uploads/stream-placeholder.jpg",
    description:
      "Full-screen animated overlay for the Logitech G Pro X Superlight. Renders across the full stream viewport between rounds.",
  ...
  },
  {
    ...
    streamBg: "/lovable-uploads/stream-placeholder.jpg",
    description:
      "Full-screen animated overlay for Foodora Summer Promo. Runs between rounds or on a sponsor cue.",
    overlayStyle: "absolute inset-0 w-full h-full object-cover",
  },
  {
    brand: "Surfshark",

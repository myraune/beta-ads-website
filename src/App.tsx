...
const translations = {
  en: {
    ...
    step1Desc: "Awareness? Traffic?",
    step2Title: "We Create Native Artwork",
    step2Desc: "Your brand integrated into the stream",
    step3Title: "Launch Across 100s of Streams",
    step3Desc: "Real-time, simultaneous deployment",
    step4Title: "Track & Optimize",
    step4Desc: "Weekly reports, real-time dashboard, clear ROI",
    // Ad Formats Section
    ...
    ourWork: "Our Work",
    realCampaigns: "Real campaigns. Real results.",
  ...
  no: {
    ...
    heroTitle: ["Din merkevare. En del av streamen.", "Ikke i veien."],
    heroDescription: "Native annonsering på Twitch som omgår adblock, når Gen Z autentisk, og leverer 3-5x høyere engasjement enn tradisjonelle videoannonser.",
    heroSubDescription: "Ingen tvungne integrasjoner. Bare garantert synlighet.",
    brandButton: "Se Demo",
    streamerButton: "Book en Samtale",
    ...
    caseVideoTitle: "Samsung-kampanjen",
    watchVideo: "Se med lyd",
    ...
    // How It Works Section
    howItWorksSectionTitle: "Slik Fungerer Det",
    howItWorksSectionSubtitle: "Fra brief til sending i 4 enkle steg",
    step1Title: "Definer Målet Ditt",
    step1Desc: "Synlighet? Trafikk?",
    step2Title: "Vi Lager Native Grafikk",
    step2Desc: "Din merkevare integrert i streamen",
    step3Title: "Lanser på 100-vis av Streams",
    step3Desc: "Sanntid, samtidig utrulling",
    step4Title: "Spor og Optimaliser",
    step4Desc: "Ukentlige rapporter, sanntids dashboard, tydelig ROI",
    // Ad Formats Section
    adFormatsTitle: "Annonseformater",
    adFormatsSubtitle: "Native annonsering designet for live streaming",
    bestFor: "Best for",
    // Case Studies Section
    ourWork: "Vårt Arbeid",
    realCampaigns: "Ekte kampanjer. Ekte resultater.",
    viewAllCases: "Se alle case-studier",
    impressions: "Visninger",
    ctr: "CTR",
    // Newsletter
    newsletterTitle: "Få Nordiske Twitch-markedsinnsikter",
    newsletterSubtitle: "Interessert i førstehåndsinformasjon om det nordiske Twitch-markedet?",
    ...
    seeInAction: "Se Beta Ads i aksjon",
    demoFormDescription: "Fyll ut skjemaet under eller book en samtale direkte med teamet vårt.",
    bookCallDirect: "Book en Samtale Direkte",
    orFillForm: "Eller fyll ut skjemaet",
    name: "Navn",
    email: "E-post",
    company: "Bedrift",
    message: "Melding",
  ...
  sv: {
    heroSubtitle: "Nordisk Twitch-byrå",
    heroTitle: ["Ditt varumärke. En del av strömmen.", "Inte i vägen."],
    heroDescription: "Native annonsering på Twitch som kringgår adblock, når Gen Z autentiskt, och levererar 3-5x högre engagemang än traditionella videoannonser.",
    heroSubDescription: "Inga tvingade integrationer. Bara garanterad synlighet.",
    brandButton: "Se Demo",
    streamerButton: "Boka ett Samtal",
    ...
    // How It Works Section
    howItWorksSectionTitle: "Så Fungerar Det",
    howItWorksSectionSubtitle: "Från brief till sändning i 4 enkla steg",
    step1Title: "Definiera Ditt Mål",
    step1Desc: "Synlighet? Trafik?",
    step2Title: "Vi Skapar Native Grafik",
    step2Desc: "Ditt varumärke integrerat i strömmen",
    step3Title: "Lansera på 100-tals Strömmar",
    step3Desc: "Realtid, samtidig utrullning",
    step4Title: "Spåra och Optimera",
    step4Desc: "Veckorapporter, realtids dashboard, tydlig ROI",
    // Ad Formats Section
    adFormatsTitle: "Annonsformat",
    adFormatsSubtitle: "Native annonsering designad för live streaming",
    bestFor: "Bäst för",
    // Case Studies Section
    ourWork: "Vårt Arbete",
    realCampaigns: "Riktiga kampanjer. Riktiga resultat.",
    viewAllCases: "Se alla fallstudier",
    impressions: "Visningar",
    ctr: "CTR",
    // Newsletter
    newsletterTitle: "Få Nordiska Twitch-marknadsinsikter",
    newsletterSubtitle: "Intresserad av förstahandsinformation om den nordiska Twitch-marknaden?",
    ...
    seeInAction: "Se Beta Ads i aktion",
    demoFormDescription: "Fyll i formuläret nedan eller boka ett samtal direkt med vårt team.",
    bookCallDirect: "Boka ett Samtal Direkt",
    orFillForm: "Eller fyll i formuläret",
    name: "Namn",
    email: "E-post",
    company: "Företag",
    message: "Meddelande",
    ...
    heroTitle: ["Brändisi. Osa streamia.", "Ei tiellä."],
    heroDescription: "Native-mainonta Twitchissä, joka ohittaa mainosten eston, tavoittaa Gen Z:n aidosti ja tuottaa 3-5x korkeamman sitoutumisen kuin perinteiset videomainokset.",
    heroSubDescription: "Ei pakotettuja integraatioita. Vain taattu näkyvyys.",
    brandButton: "Katso Demo",
    streamerButton: "Varaa Puhelu",
    ...
    caseVideoTitle: "Samsung-kampanja",
    watchVideo: "Katso äänellä",
    ...
    // How It Works Section
    howItWorksSectionTitle: "Näin Se Toimii",
    howItWorksSectionSubtitle: "Briefistä lähetykseen 4 yksinkertaisessa vaiheessa",
    step1Title: "Määrittele Tavoitteesi",
    step1Desc: "Näkyvyys? Liikenne?",
    step2Title: "Luomme Native-grafiikan",
    step2Desc: "Brändisi integroituna streamiin",
    step3Title: "Julkaise Sadoissa Streameissa",
    step3Desc: "Reaaliaikainen, samanaikainen käyttöönotto",
    step4Title: "Seuraa ja Optimoi",
    step4Desc: "Viikkoraportit, reaaliaikainen kojelauta, selkeä ROI",
    // Ad Formats Section
    adFormatsTitle: "Mainosmuodot",
    adFormatsSubtitle: "Native-mainonta suunniteltu live-streamaukseen",
    bestFor: "Parhaiten",
    // Case Studies Section
    ourWork: "Työmme",
    realCampaigns: "Oikeita kampanjoita. Oikeita tuloksia.",
    viewAllCases: "Katso kaikki tapaustutkimukset",
    impressions: "Näyttökerrat",
    ctr: "CTR",
    // Newsletter
    newsletterTitle: "Saa Pohjoismaisia Twitch-markkinanäkemyksiä",
    newsletterSubtitle: "Kiinnostaako ensikäden tieto pohjoismaisesta Twitch-markkinasta?",
    ...
    seeInAction: "Näe Beta Ads toiminnassa",
    demoFormDescription: "Täytä alla oleva lomake tai varaa puhelu suoraan tiimimme kanssa.",
    bookCallDirect: "Varaa Puhelu Suoraan",
    orFillForm: "Tai täytä lomake",
    name: "Nimi",
    email: "Sähköposti",
    company: "Yritys",
    message: "Viesti",
...
const App = () => {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <ThemeProvider attribute="class" defaultTheme="dark" enableSystem={false} storageKey="beta-ads-theme">
        <Toaster />
        <Sonner />
        <BrowserRouter>
          <Routes>
